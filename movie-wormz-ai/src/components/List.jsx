          ...
          movies.map((mov) => (
            ...
            >
              {mov.poster_path ? (
                ...
                <text x="100" y="40" text-anchor="middle" font-family="Arial" font-size="20" font-weight="bold" fill="black" textLength="160" lengthAdjust="spacingAndGlyphs">{mov.title}</text>
                <text x="100" y="55" text-anchor="middle" font-family="Arial" font-size="14" fill="#000000">{mov.release_date}</text>
