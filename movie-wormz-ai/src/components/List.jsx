  ...
  return (
    <div id="container">
      <div class="search-results">
        {searchTerm && <p>🔎 <b>Showing search results for:</b> <i>{searchTerm}</i></p>}
      </div>
      <div className="App-list" style={{ transform: gridTransform }}>
        {movies.length > 0 ? (
          movies.map((mov) => (
            <div className="mov" key={mov.id}>
              {mov.poster_path ? (
                <img
                ...
                >
                  <path
                    d="M10 10 L190 10 Q200 10, 200 20 L200 280 Q200 290, 190 290 L10 290 Q0 290, 0 280 L0 20 Q0 10, 10 10"
                    fill="#fbefbe"
                    stroke="#000000"
                    stroke-width="2"
                  />
