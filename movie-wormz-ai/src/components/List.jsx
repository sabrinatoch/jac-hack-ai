          ...
          movies.map((mov) => (
            ...
            >
              {mov.poster_path ? (
                ...
                <text x="100" y="40" text-anchor="middle" font-family="Arial" font-size="20" fontWeight="bold" fill="black" textLength="160" lengthAdjust="spacingAndGlyphs">{mov.title}</text>
